...
services = st.sidebar.selectbox('Services', ['Business cards/flyer', 'Web Development' ,'Printing','Flyer Distribution'], key='services_selectbox')
...
if edit_number:
    ...
    services = st.sidebar.selectbox('Services', ['Business cards/flyer', 'Web Development' ,'Printing','Flyer Distribution'], index=['Business cards/flyer', 'Web Development' ,'Printing','Flyer Distribution'].index(edit_row['Services']), key='edit_services')
